## defer_run.cpp
Compilation command: g++ defer_run.cpp

Note: If compilation fails with the following error:
```
...
|     ^~~~~
```
Try specifying the C++ standard to 17 or higher, such as 20. Alternatively, upgrade your g++ version. A working version is:
```
✗ g++ -v           
